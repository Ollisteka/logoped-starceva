  ...
  const portfolioStats = [
    {
      title: "Учащиеся",
      value: `45${NBSP}+`,
      description: `Детей на${NBSP}коррекционном сопровождении`
    },
    {
      title: "Эффективность",
      value: "92%",
      description: `Учащихся с${NBSP}положительной динамикой`
    },
    {
      title: "Методики",
      value: `15${NBSP}+`,
    ...
    },
    {
      title: "Опыт работы",
      value: `8${NBSP}лет`,
      description: `В${NBSP}сфере логопедии`
    }
  ];

  const achievements = [
    "Благодарность Министерства образования Свердловской области (2024)",
    `Почётная грамота Управления образования г.${NBSP}Екатеринбурга (2023)`,
    `Благодарственное письмо от${NBSP}родительского комитета (2023)`,
