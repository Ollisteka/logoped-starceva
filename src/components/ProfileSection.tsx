...
export function ProfileSection() {
  const profileData = [
    ...
    },
    {
      ...
      value: "Диагностика речевых нарушений, коррекция звукопроизношения, развитие речи, коррекция дисграфии и дислексии"
    },
    {
      label: "Увлечения",
      value: "Одно из увлечений это моя работа. Мне нравится быть логопедом, с каждым годом всё больше."
    },
    {
      label: "Регион",
    ...
    {
      label: "Место работы",
      value: 'ГБОУ СО "ЕШИ №12, реализующая адаптированные основные общеобразовательные программы", г. Екатеринбург'
    }
  ];
            ...
            <div className="flex-1 space-y-6 w-full">
              {profileData.map((item, index) => (
                <div key={index} className="border-l-4 border-primary/20 pl-4 py-2">
                  <h3 className="text-primary/80 mb-1">{item.label}</h3>
