...
const competitions = [
  {
    title: 'Выставка-конкурс педагогической продукции «Мы вместе»',
    year: '2026',
    result: '2 место',
    description: `Номинация «Дидактическая игра», конкурсная работа «От слога к${NBSP}слову»`,
    level: 'Областной',
    downloads: [
      {
        href: getDocumentPath('mi-vmeste/certificate.jpg'),
        text: 'Сертификат',
      },
      {
        href: getDocumentPath('mi-vmeste/poloshenie.pdf'),
        text: 'Положение',
      },
    ],
  },
